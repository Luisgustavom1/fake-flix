...
@Injectable()
export class AccessControlService {
  constructor(private readonly billingPublicApi: BillingPublicApiProvider) {}

  async canAccessContent(userId: string, contentId: string): Promise<boolean> {
    const isActive =
      await this.billingPublicApi.isUserSubscriptionActive(userId);
...
@Injectable()
export class AccessControlService {
  constructor(private readonly billingFacade: BillingFacade) {}
